...
<div class="card card-primary card-outline">
    <div class="card-header">
        <h5 class="card-title">Aircarft Service Requests Report</h5>
    </div>
    <div class="card-body">
        <form id="filter-form">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['aircarft_name'] ?></td>
                        <td><?php echo $row['aircarft_registration_number'] ?></td>
