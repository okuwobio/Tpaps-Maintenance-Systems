...
<script>
	...
	$('#manage-user').submit(function(e){
		...
		if (!checkPassword(pass)) {
			$('#msg').html('<div class="alert alert-danger">Password should contain at least 8 letter password, with at least a symbol, upper and lower case letters and a number</div>')
